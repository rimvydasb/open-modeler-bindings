...
import {evalWorkbook, clearTrace, mutateInput} from '@open-modeler-bindings/v1alpha/bindings';
import {CreditEligibilityModel, INITIAL_APPLICATION} from '../demo/credit-eligibility/main.ts';
